...
\subsubsection*{7. Flexibility and Efficiency of Use}
        ...
        7.11 & 5 & 10 & The diagramming rule of distorting the model in order to see hidden layers (see p.7 \cite{origrammer}) is unflexible when having to change every single line by hand\\ \hline
        \end{tabular}
