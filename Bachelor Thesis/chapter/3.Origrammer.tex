...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.75\textwidth]{OrigrammerMainParts}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.66\textwidth]{newDiagram}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.43\textwidth]{origrammerPreferences}
